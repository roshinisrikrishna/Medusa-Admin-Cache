...
function Typography() {
  ...
  return (
    ...
    <Col lg={3} className="career-col" style={{ backgroundColor: "#CCC6C6",padding:"0%", justifyContent: "center", textAlign: "center", lineHeight: "1.2em"}}>
...
<p className="career-pr1" style={{
  ...
  Read More
        ...
        <Col lg={3} className="career-col" style={{backgroundColor:"#F0EDED",padding:"0%",justifyContent: "center", textAlign: "center", lineHeight: "1.2em"}}>
 ...
 Read More
        ...
        <Col lg={3} className="career-col" style={{backgroundColor:"#FADCD6",padding:"0%",justifyContent: "center", textAlign: "center", lineHeight: "1.2em"}}>
...
<p className="career-pr3" style={{
 ...
 ':hover': {
  ...
  Read More
        ...
        <Col lg={3} className="career-col" style={{backgroundColor:"#E5C7B5",padding:"0%",justifyContent: "center", textAlign: "center", lineHeight: "1.2em"}}>
