...
const CustomerDetail = () => {
  ...
  // Update state when Delete action is clicked
 const handleDelete = (id) => {
  console.log("customer id at deletion ", id);  // Create a new copy of the customer object
   console.log("customer at deletion ",customer)
   ...
   medusa.admin.customers.update(id, {
    customer_active: "true" 
  })
  .then(({ customer }) => {
    console.log("customer update",customer.id);
  })
