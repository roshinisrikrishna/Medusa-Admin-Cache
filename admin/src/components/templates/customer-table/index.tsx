...
const CustomerTable = () => {
  ...
  const filteredCustomers = customers?.filter(customer => 'customer_active' in customer && customer.customer_active !== "true");
  console.log("filtered customers at main page ",filteredCustomers);
            ...
            return (
              <Table.Row
                ...
                actions={[
                  ...
                  {
                    label: t("customer-table-delete", "Delete"),
                    onClick: () => navigate(row.original.id),
